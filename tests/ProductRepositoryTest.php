...
final class ProductRepositoryTest extends TestCase
{
  public function testMockProducts() {
    ...
    $this->assertEquals(
        10,
        count($productRepository->getAllMockProducts($feature = "0"))
    );
  }
  ...
  public function testMockProductName() {
    ...
    $productRepository = new ProductRepository();
    $this->assertContains( $productRepository->getAllMockProducts($feature = "0")[0]->name, $items );
  }

  public function testMockProductId() {
    $productRepository = new ProductRepository();
    $id = $productRepository->getAllMockProducts($feature = "0")[0]->id;
